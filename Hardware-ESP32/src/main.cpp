...
#define SERVO_CENTER_X  88   
#define SERVO_CENTER_Y  88   
...
#define INCREMENTO_MAX 1.5f //angulo muda 1.5 graus por ciclo (maximo)
#define INCREMENTO_MIN 0.2f //muda 0.2 por ciclo (saindo da deadzone)
...
void resetarCentro() {
  anguloX = SERVO_CENTER_X;  
  anguloY = SERVO_CENTER_Y;  
  servoX.write(SERVO_CENTER_X);  
  servoY.write(SERVO_CENTER_Y);  
}